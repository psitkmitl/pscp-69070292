...
```text
output season depend on the month given and if it third month of that season on 21 day onward output it next season
```
...
Step 2:write to take int input
Step 3:write if day is >= 21 increase month by 1
Step 4:write if for all season output
Step 5:test for all case possible
```
...
```text
test for third month of winter 21 day after
```
...
```text
test for third month of spring 21 day after
```
