...
```text
take temperature take unit convert it to another unit output 2 deci
```
...
Step 2:write to take temp int input and two unit str input
Step 3:write to convert all to C
Step 4:write to convert C to unit2
Step 5:write to output in 2 deci
```
